...
<div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
            <form class="row" action="<c:url value='/profile-page'/>" method="post" enctype="multipart/form-data">
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="p-3 p-lg-5 border">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="summary" id="summary" cols="30" rows="5" class="form-control"
                                      placeholder="Write your notes here...">${account.summary}</textarea> <%-- Assuming account.summary exists --%>
                        </div>
