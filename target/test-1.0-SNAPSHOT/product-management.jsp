                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${product_list}" var="o">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value='/edit-product?product-id=${o.id}'/>" class="btn btn-primary btn-sm"
                                           style="background-color: green ; border-color: green">
                                            <span class="icon icon-pencil"></span>
                                        </a>

                                        <a href="<c:url value='/remove-product?product-id=${o.id}'/>"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="modal fade bd-example-modal-lg" id="addProductModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <form class="modal-content"action="<c:url value='/add-product'/>" method="post"
