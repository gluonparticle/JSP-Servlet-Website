                            ...
                            <div class="site-block-27">
                                <ul>
                                    <c:if test="${page_active > 1}">
                                        <li><a href="<c:url value='/shop?index=${page_active - 1}'/>"><</a></li>
                                    </c:if>

                                    <c:forEach begin="1" end="${total_pages}" var="i">
                                        <li class="${(page_active == i) ? "active" : " "}"><a
                                                href="<c:url value='/shop?index=${i}'/>">${i}</a></li>
                                    </c:forEach>
                        ...
                        <ul class="list-unstyled mb-0">
                            <c:forEach items="${category_list}" var="o">
                                <li class="mb-1 active">
                                    <a href="<c:url value='/category?category_id=${o.id}'/>" class="d-flex">
                                        <span>${o.name}</span>
